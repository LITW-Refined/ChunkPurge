...
public class HandlerConfig {
    ...
    public HandlerConfig(File configurationFile) {
        ...
        properties.chunkUnloadDelay = config.get(
                Configuration.CATEGORY_GENERAL,
                "chunkUnloadDelay",
                600,
